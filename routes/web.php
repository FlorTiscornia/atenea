...
//C
Route::get('/user/{id}/grade/create', [GradeController::class, 'create'])->name('createGrade')->middleware('isTeacher', 'auth');
Route::post('/user/{id}/grade', [GradeController::class, 'store'])->name('storeGrade')->middleware('isTeacher', 'auth');
